...
Bitcoin <- subset(cryptoData2, symbol =="BTC" & date >= "2014-1-1" & date <= "2016-12-31")
...
class(Bitcoin$open)
Bitcoin$open <- as.integer(Bitcoin$open)

class(Bitcoin$open)

minOpen <- min(Bitcoin$open)
maxOpen <- max(Bitcoin$open)
...
BitcoinTimeSeries<-ts(Bitcoin$open, start=c(2014,1), end=c(2016,365), frequency=365)
...
```{r}
trainBitcoin<- window(BitcoinTimeSeries, start = c(2014,1), end= c(2016,304), frequency=304)
testBitcoin<- window(BitcoinTimeSeries, start=c(2016,305), end = c(2016, 365), frequency = 60)

#trainBitcoin2<- window(BitcoinTimeSeries, start = c(2014,1), end= c(2016,365), frequency=304)
...
testBitcoin
plot(testBitcoin)
etsFit <- ets(trainBitcoin, model = 'ZZZ', damped = FALSE)
