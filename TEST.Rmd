...
Bitcoin <- subset(cryptoData2, symbol =="BTC" & date >= "2014-01-01" & date <= "2016-10-31")
...
```{r}
trainBitcoin<- window(BitcoinTimeSeries, start = c(2014,1), end= c(2016,305), frequency=365)
testBitcoin<- window(BitcoinTimeSeries, start=c(2016,306), end = c(2016,365), frequency = 365)
