...
```{r}
trainBitcoin<- ts(BitcoinTimeSeries, start = c(2014,11), end= c(2016,10), frequency=30)
testBitcoin<- ts(BitcoinTimeSeries, start=c(2016,11), end = c(2016, 12), frequency = 30)
